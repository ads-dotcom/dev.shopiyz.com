...
const requiredRateLimitSuccessHeaders = [
  ...
  "X-Shopiyz-API-Limit",
  "X-Shopiyz-API-Remaining",
  "X-Shopiyz-API-Restore-Rate",
  "X-Shopiyz-API-Retry-After",
  "X-Request-Id",
];
...
const requiredTypedRequestSchemas = new Map([
  ...
  ["POST /search/query/parse.json", "#/components/schemas/SearchQueryRequest"],
  ["POST /search/query/validate.json", "#/components/schemas/SearchQueryRequest"],
  ["POST /search/query/explain.json", "#/components/schemas/SearchQueryRequest"],
  ["POST /search/test.json", "#/components/schemas/SearchQueryRequest"],
  ["POST /saved_searches.json", "#/components/schemas/SavedSearchRequest"],
  ["PATCH /saved_searches/{search_id}.json", "#/components/schemas/SavedSearchRequest"],
  ["PATCH /settings/online_store_preferences.json", "#/components/schemas/OnlineStorePreferencesInput"],
  ["POST /storefront/password/enable.json", "#/components/schemas/StorefrontPasswordInput"],
  ["POST /storefront/password/disable.json", "#/components/schemas/StorefrontPasswordInput"],
  ["PATCH /storefront/password.json", "#/components/schemas/StorefrontPasswordInput"],
  ["POST /storefront/launch_checklist/run.json", "#/components/schemas/LaunchChecklistRunRequest"],
  ["POST /publishables/{resource_type}/{resource_id}/publish.json", "#/components/schemas/PublishingInput"],
  ["POST /publishables/{resource_type}/{resource_id}/unpublish.json", "#/components/schemas/PublishingInput"],
  ["POST /publishables/{resource_type}/{resource_id}/schedule.json", "#/components/schemas/PublishingInput"],
  ["PATCH /collections/{collection_id}/product_positions.json", "#/components/schemas/CollectionProductPositionRequest"],
  ["POST /collections/{collection_id}/product_positions/reorder.json", "#/components/schemas/CollectionProductPositionRequest"],
  ["POST /collections/{collection_id}/product_positions/preview.json", "#/components/schemas/CollectionProductPositionRequest"],
  ["PATCH /categories/{category_id}/product_positions.json", "#/components/schemas/CollectionProductPositionRequest"],
  ["POST /categories/{category_id}/product_positions/reorder.json", "#/components/schemas/CollectionProductPositionRequest"],
  ["POST /sort_rules.json", "#/components/schemas/SortRuleRequest"],
  ["PATCH /sort_rules/{rule_id}.json", "#/components/schemas/SortRuleRequest"],
  ["POST /files/staged_uploads.json", "#/components/schemas/StagedUploadRequest"],
  ["POST /files/uploads.json", "#/components/schemas/FileRequest"],
  ["POST /files/library.json", "#/components/schemas/FileRequest"],
  ["PATCH /files/library/{file_id}.json", "#/components/schemas/FileRequest"],
  ["POST /files/{file_id}/attach.json", "#/components/schemas/FileRelationRequest"],
  ["POST /files/{file_id}/detach.json", "#/components/schemas/FileRelationRequest"],
  ["POST /files/{file_id}/replace.json", "#/components/schemas/FileRelationRequest"],
  ["POST /bulk_operations.json", "#/components/schemas/BulkOperationRequest"],
  ["POST /bulk_operations/{operation_id}/cancel.json", "#/components/schemas/BulkOperationRequest"],
  ["POST /webhooks/test_delivery.json", "#/components/schemas/WebhookTestDeliveryRequest"],
  ["POST /webhook_deliveries/{delivery_id}/retry.json", "#/components/schemas/WebhookDeliveryRetryRequest"],
  ["POST /media/assets/{asset_id}/alt_text_suggestions.json", "#/components/schemas/MediaAltTextSuggestionRequest"],
  ["POST /media/assets/{asset_id}/transforms.json", "#/components/schemas/MediaTransformRequest"],
  ["POST /media/assets/bulk_actions.json", "#/components/schemas/MediaBulkActionRequest"],
  ["POST /media/export.json", "#/components/schemas/MediaExportRequest"],
  ["POST /media/import.json", "#/components/schemas/MediaImportRequest"],
  ["POST /content/media_assets/optimize_preview.json", "#/components/schemas/MediaOptimizeRequest"],
  ["POST /content/media_assets/optimize.json", "#/components/schemas/MediaOptimizeRequest"],
  ["PATCH /orders/{order_id}.json", "#/components/schemas/OrderUpdateRequest"],
  ["POST /orders/{order_id}/actions.json", "#/components/schemas/OrderActionRequest"],
  ["POST /orders/{order_id}/archive.json", "#/components/schemas/OrderArchiveInput"],
  ["POST /orders/{order_id}/unarchive.json", "#/components/schemas/OrderArchiveInput"],
  ["POST /orders/{order_id}/notes.json", "#/components/schemas/OrderNoteInput"],
  ["PATCH /orders/{order_id}/notes/{note_id}.json", "#/components/schemas/OrderNoteInput"],
  ["POST /orders/{order_id}/tags.json", "#/components/schemas/OrderTagInput"],
  ["POST /orders/{order_id}/risk.json", "#/components/schemas/OrderRiskInput"],
  ["POST /articles.json", "#/components/schemas/ArticleRequest"],
  ["PATCH /articles/{article_id}.json", "#/components/schemas/ArticleRequest"],
  ["POST /blogs.json", "#/components/schemas/BlogRequest"],
  ["PATCH /blogs/{blog_id}.json", "#/components/schemas/BlogRequest"],
  ["POST /comments.json", "#/components/schemas/CommentRequest"],
  ["PATCH /comments/{comment_id}.json", "#/components/schemas/CommentRequest"],
  ["POST /comments/{comment_id}/approve.json", "#/components/schemas/CommentModerationRequest"],
  ["POST /discounts.json", "#/components/schemas/DiscountRequest"],
  ["PATCH /discounts/{discount_id}.json", "#/components/schemas/DiscountRequest"],
  ["POST /discounts/{discount_id}/activate.json", "#/components/schemas/DiscountActionRequest"],
  ["POST /discounts/{discount_id}/preview.json", "#/components/schemas/DiscountActionRequest"],
  ["PATCH /checkout/branding.json", "#/components/schemas/CheckoutSettingsRequest"],
  ["POST /cart/rules.json", "#/components/schemas/CartRuleRequest"],
  ["POST /xml/feeds.json", "#/components/schemas/XmlFeedRequest"],
  ["POST /xml/feeds/{feed_id}/preview.json", "#/components/schemas/XmlFeedRequest"],
